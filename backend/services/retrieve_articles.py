...
def feedparser_end(q):
    ...
    queries = ["rajesh mehta rajesh exports"]
    feeds = []
    for q in queries:
...
def gnews_end(q):
    ...
    url = f"https://gnews.io/api/v4/search?q=rajesh%20mehta&country=IN&lang=en&max=10&apikey={apikey}"
...
def newsapi_end(q):
    ...
    querystring = {"q": "Rajesh mehta rajesh exports scam", "apiKey": apikey}
